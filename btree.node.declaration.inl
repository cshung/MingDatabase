...
public:
    ...
    virtual result_t insert(buffer key, buffer value, insert_result* p_insert_result) = 0;
private:
...
public:
    ...
    virtual result_t insert(buffer key, buffer value, insert_result* p_insert_result);
};
